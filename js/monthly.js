...
axios
  .get(`https://tastynuts.rocket-coding.com/api/subscription/${eachProductId}`)
  .then(function (response) {
    ...
    //                                     <img src="${url}/${item.subscriptionImg02}" class="d-block w-100" alt="...">
    //                                 </div>
    //                                 <div class="carousel-item">
    //                                     <img src="${url}/${item.subscriptionImg03}" class="d-block w-100" alt="...">
    //                                 </div>
    //                                 <div class="carousel-item">
    //                                     <img src="${url}/${item.subscriptionImg04}" class="d-block w-100" alt="...">
    //                                 </div>
    //                             </div>
    ...
    //                         <option value="1">雙週配送</option>
    //                         <option value="2">每月配送</option>
    //                         <option value="3">每季配送</option>

    //                     </select>
    //                     <button class="btn btn-outline-secondary" data-id="sub" type="button">加到購物車</button>
    //                 </div>
    //                 </div>
    ...
    //       axios.post(`https://tastynuts.rocket-coding.com/api/`, {
    //           "item:": {
    //               "productImage"
    //             "productName":,
    //             "productPrice":,
